...
async def s_c(interaction: discord.Interaction, to_check: str):
...
async def s_ca(interaction: discord.Interaction, to_check: str):
...
async def s_mc(interaction: discord.Interaction, to_check: str):
